...
ADDRESS            PORT      TYPE
0.0.0.0            7000      HTTP # INADDR_ANY + mall/order service http port -> rds route_config_name: "7000"  "outbound|7000||mall.demo.svc.cluster.local" 出
...
172.21.255.203     4000      TCP  # order service ip + order service tcp port ->
......
```
